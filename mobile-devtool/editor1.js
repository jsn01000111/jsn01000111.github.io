javascript:(function() {
    ...
    editorStyle.innerHTML = `
        #__cleanDevEditorContainer {
            ...
            position: fixed; /* Keep it fixed for dragging */
            /* Initial positioning and size - more flexible for various screen sizes */
            top: 50%;
            left: 50%;
        ...
        #__cleanDevEditorContainer * {
            ...
            /* user-select: none; is applied by default due to all: initial, then explicitly allowed for textareas */
        }
    ...
    let offsetX, offsetY;
    let editorRect; // To store current dimensions
    ...
    editorContainer.addEventListener('mousedown', function(e) {
        ...
        if (e.target.classList.contains('__editor-header') || e.target.tagName === 'SPAN') {
            ...
            // To prevent issues with text selection in the header, capture pointer
    ...
    document.addEventListener('mousemove', function(e) {
        ...
        // Constrain new position to within the viewport
