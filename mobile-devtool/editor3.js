(function() {
    ...
    editorContainer.innerHTML = `
        ...
        <div class="__myeditor-content">
            ...
            <div id="__myjsConsolePane" class="__myeditor-pane">
                <textarea id="__myjsEditor" class="js-input" placeholder="Write JavaScript here..."></textarea>
                <textarea id="__myjsOutput" class="js-output" readonly placeholder="Console Output..."></textarea>
    ...
    executeJsBtn.addEventListener('click', function() {
        ...
        try {
            ...
            // Using 'eval' is generally risky in production but acceptable for a dev tool bookmarklet.
            // A safer alternative for a more complex tool would be to create an iframe and execute there.
    ...
    function rebindEditorEvents(retainedEditorContainer, state, retainedUserStyleEl, retainedEditorStyle, originalConsoleMethods) {
        ...
        newEditorPanes.forEach(pane => {
            const paneId = pane.id.replace('__my', '').replace('Editor', '').replace('ConsolePane', '');
