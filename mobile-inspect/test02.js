javascript:(function() {
  ...
  // A flag to prevent click event on the close button after a drag
  ...
  const dragMove = (e) => {
    ...
    hasDragged = true; // Set drag flag if movement occurs
  ...
  runBtn.onclick = () => {
    ...
    try {
      // Create a function wrapper to prevent `var` from polluting global scope
      // and allow `return` to work
